...
const helpSteps = [
  ...
  },
  {
    ...
    content:
      "Use the dashboard to browse all books currently available in the platform. You can search by title, author, genre, or description and quickly see which books are available or already borrowed.",
  },
  {
    id: "borrow",
    title: "3. Borrow a book",
    content:
      "Each available book card includes a return date calendar and a Borrow Book button. Pick a date starting from today, then borrow the book. Once borrowed, that title is reserved for you and marked unavailable to others.",
  },
  {
    id: "profile",
  ...
  },
  {
    ...
    content:
      "When you finish reading, open My Profile and click Return book. This makes the book available again so someone else in the community can borrow it.",
  },
  {
    id: "admin",
    title: "6. Add books from the admin panel",
    content:
      "Use the Admin Panel to add books with title, author, genre, description, owner information, reading content, and optional reading links. Duplicate titles are blocked so the catalog stays clean and easy to manage.",
  },
];
    ...
    <div className="help-container">
      ...
      <section className="help-grid">
        ...
        <div className="help-summary-card">
          ...
          <ul className="help-list">
            <li>`Dashboard`: browse, search, and borrow books.</li>
            <li>`My Profile`: view borrowed books, read them, and return them.</li>
            <li>`Admin Panel`: add new books and reading content.</li>
      ...
      <section className="help-summary-card help-tips">
        <h3>Helpful Notes</h3>
        <ul className="help-list">
          <li>A borrowed book becomes unavailable to other users until it is returned.</li>
          ...
          <li>If an admin tries to add a title that already exists, the app now shows an error instead of creating a duplicate entry.</li>
        </ul>
      </section>
    </div>
  );
